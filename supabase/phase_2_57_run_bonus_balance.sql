...
-- Schwellen und Grundwerte bleiben unveraendert; nur scoreRuns/xpRuns
-- sowie die beiden Run-Deckel werden aus der zentralen Balance aktualisiert.
...
begin
  if not exists (
    ...
    where singleton = true and schema_version in (56, 57)
  ) then
    raise exception 'Phase 2.56 muss vor Phase 2.57 ausgefuehrt werden';
  end if;
end;
$$;
...
set schema_version = 57,
    migration_name = 'phase_2_57_run_bonus_balance.sql',
    applied_at = now()
