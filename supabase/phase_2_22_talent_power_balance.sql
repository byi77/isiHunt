-- Aktualisiert die Talentwirkung auf die mathematisch begrenzte Machtkurve.
--
-- `phase_2_21` ist bereits als ausgefuehrte Migration dokumentiert und wird
-- deshalb nicht rueckwirkend geaendert. Diese Migration ersetzt nur die
-- Balance-Funktion; `purchase_talent()` liest ihre Kosten und Maximalraenge
-- weiterhin aus genau dieser Funktion.
