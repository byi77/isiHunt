...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  achievement(
    'combo_125',
    'Tagesjäger',
    'Schließe insgesamt 7 Tagesläufe ab.',
    6,
    (save) => save.totalDailyRuns >= 7,
  ),
  achievement(
    'combo_150',
    'Tageshüter',
    'Schließe insgesamt 30 Tagesläufe ab.',
    7,
    (save) => save.totalDailyRuns >= 30,
  ),
  ...
  achievement(
    'score_5000',
    'Reliktjäger',
    'Erreiche 3.000 Punkte in einem Run.',
    2,
    (save) => save.bestScore >= 3_000,
  ),
  achievement(
    'score_15000',
    'Punktemeister',
    'Erreiche 6.000 Punkte in einem Run.',
    3,
    (save) => save.bestScore >= 6_000,
  ),
  achievement(
    'score_30000',
    'Lichtrekord',
    'Erreiche 10.000 Punkte in einem Run.',
    4,
    (save) => save.bestScore >= 10_000,
  ),
  achievement(
    'score_60000',
    'Unfassbarer Lauf',
    'Erreiche 16.000 Punkte in einem Run.',
    5,
    (save) => save.bestScore >= 16_000,
  ),
  achievement(
    'score_100000',
    'Sechsstellig',
    'Erreiche 24.000 Punkte in einem Run.',
    6,
    (save) => save.bestScore >= 24_000,
  ),
  achievement(
    'score_150000',
    'Lichtblitz',
    'Erreiche 35.000 Punkte in einem Run.',
    7,
    (save) => save.bestScore >= 35_000,
  ),
