...
export const TALENTS: readonly TalentDef[] = [
  {
    id: 'reach',
    name: 'Reichweite',
    description: 'Vergroessert den Radius, in dem du Relikte einsammelst.',
    maxRank: 5,
    perRank: '+6 Radius',
  },
  {
  ...
  },
  {
    id: 'magnetism',
    name: 'Magnetismus',
    description: 'Relikte in der Naehe werden zu dir gezogen.',
    maxRank: 4,
  ...
  },
  {
    id: 'endurance',
    name: 'Ausdauer',
    description: 'Verlaengert die Dauer eines Runs.',
    maxRank: 4,
    perRank: '+4 Sekunden',
  },
  {
    id: 'focus',
    name: 'Fokus',
    description: 'Deine Combo haelt laenger, bevor sie zerfaellt.',
    maxRank: 4,
  ...
  },
  {
    id: 'insight',
    name: 'Erkenntnis',
    description: 'Du erhaeltst mehr Erfahrung pro Relikt.',
    maxRank: 5,
    perRank: '+8% XP',
  },
  {
    id: 'fortune',
    name: 'Gunst',
    description: 'Du erhaeltst mehr Punkte pro Relikt.',
    maxRank: 5,
    perRank: '+6% Punkte',
  },
];
